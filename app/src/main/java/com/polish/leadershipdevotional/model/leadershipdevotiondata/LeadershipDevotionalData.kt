package com.polish.leadershipdevotional.model.leadershipdevotiondata

object LeadershipDevotionalData {

    // so I can have an array of dayCount to hold form Day 1 to Day 44.
    val dayCount = arrayOf(
    ...
    val bibleRef = arrayOf(
            "2Timothy 1:1", "2Timothy 1:2", "2Timothy 1:3", "2Timothy 1:4", "2Timothy 1:5", "2Timothy 1:6",
            "2Timothy 1:7", "2Timothy 1:8", "2Timothy 1:9", "2Timothy 1:10", "2Timothy 1:11", "2Timothy 1:12",
            "2Timothy 1:13", "2Timothy 1:14", "2Timothy 1:15", "2Timothy 1:16", "2Timothy 1:17", "2Timothy 1:18",
            "2Timothy 2:1", "2Timothy 2:2", "2Timothy 2:3", "2Timothy 2:4", "2Timothy 2:5", "2Timothy 2:6", "2Timothy 2:7", "2Timothy 2:8",
            "2Timothy 2:9", "2Timothy 2:10", "2Timothy 2:11", "2Timothy 2:12", "2Timothy 2:13", "2Timothy 2:14", "2Timothy 2:15", "2Timothy 2:16",
            "2Timothy 2:17", "2Timothy 2:18", "2Timothy 2:19", "2Timothy 2:20", "2Timothy 2:21", "2Timothy 2:22", "2Timothy 2:23", "2Timothy 2:24",
            "2Timothy 2:25", "2Timothy 2:26"
    )

    val bibleRefText = arrayOf(
    ...
    val meditateBody = arrayOf(
            ...
            "Paul the Apostle built trust in Timothy because in any relationship trust is the channel for correction, communication, growth of partners, leadership, fellowship and impartation of a virtue. A common feature you observe in a relationship that has a well built trust structure are: submission to authority, submission to one another, genuine brotherly love amongst the brethren, genuine commitment to personal growth with an intent to abound towards every good works, etc.\n" +
                    "With keen observation here, we find out that it was consistency on a particular virtue in the life of Timothy’s grandmother, mother and in Timothy himself that persuaded Paul the Apostle to vouch that Timothy will always be true to faith of Christ Jesus which he has received without pretence.\n" +
                    "Another example of a trust-worthy person was Jesus Christ, where a voice came from heaven saying: “this is my beloved son in whom am well pleased” (Matt3:17).\n" +
                    "In Proverbs3:1-4, you will find out what one needs to do to become a trust-worthy person. Joseph is a typical of a trust-worthy person, he received honour  to function in the capacity of the Prime Minister.\n" +
                    "To them that believe in Him(Christ Jesus), He gave them power to become the sons of God.\n",
            "It is a healthy thing when leaders can identify some special abilities in their followers and thereby commit them to several tasks in other to release these abilities. It requires an amount of work for the followers to exercise themselves fully in their abilities (ACTS20:35). \n" +
                    "Some of the challenges one may fear is criticism, probably because of the level of imperfection at the beginning. This is a challenge that must be overcome because there is always a sense of fulfillment when anyone releases his God-given gift. That fulfillment is the joy of living; though one would need to count the cost (Luke).\n",
            "We know that fear is an enemy to growth; it prevents people from expressing themselves or from expressing the gift of God in them. Statements like these are symptoms of fear; how will they feel when I do this, I hope what I did was good enough, etc.. These are symptoms of fear because one tends to seek approval from some one before one act. Let’s bring to mind that seeking counsel is quiet different from this. Fear makes one indecisive; on the other hand when one seeks counsel, he has already decide to find a solution.\n" +
                    "Therefore, we may say here that one reason fear is present is because of the absent of truth(Prov19:2a, John8:32). By this scripture above, we could observe that Timothy was timid. To set him free from timidity, he gave him this truth…..  Timothy look up, you have the spirit of power, the spirit of love, the spirit of sound mind; begin to exercise yourself in this truth, Paul the Apostle instructed.\n" +
                    "The following scriptures can help you to develop God’s love inside you and begin to walk in it. 1Corinthians13:1-13, Romans5:1-8, 1John3:1, 1John4:18..\n" +
                    "Take the step to walk in His power, love and in a sound mind.\n",
